 ...
 * at 17px); the spoon's bowl is smaller than its handle, as on a real one.
 */
export default function UtensilsIcon({ size = 17 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 17 17" fill="none" aria-hidden="true">
      ...
      <ellipse cx="12.4" cy="4.55" rx="1.85" ry="2.55" stroke="currentColor" strokeWidth="1.6" />
      <path d="M12.4 7.1V15" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
    </svg>
  );
}
